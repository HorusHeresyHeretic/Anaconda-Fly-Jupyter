...
Я пишу код на Python 3.6 в VS 2015 - а Anaconda строит мне график и выводит его на экран по команде plt.show() уже средствами IPython. При этом мне не нужно беспокоиться  
