...
В иделае это 2 монитора: в первом студия и разработка, во втором Юпитер с уже полученными результатами в качетве подсказки. Это существено импрувить процесс "подумать" - если задача по интерпретации результатов data mining возложена не на коллегу, а на вас.
