...
*Тот факт, что мне приходиться использовать гит в качестве косплея браузера - не вдохновляет: в среднем я генерю около 1000 закладок в квартал из которых значительная часть связана с предметной областью (по причине того, что линки на аниме и анимешные кубу я храняю в телеграм) и по факту телега пока вне конкуренции по своей полезности  - хром, аваст, неон и мозила так красиво данные не хранят.* 

*Возможно придётся осваивать учебник по написанию ботов для телеграм и писать под себя.*
