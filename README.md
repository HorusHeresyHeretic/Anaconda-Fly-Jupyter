...
**Перед вами, возможно, самая быстрая и стабильная реализация обработки series в рамках ООП.** 

*Датафрейм хранит объекты, эти объекты классифициуються через .str.contains*
