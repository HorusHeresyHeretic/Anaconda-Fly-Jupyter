...
Смысл в том, что код написаный в студии в рамках задачи по датамайнингу - это длиннокод. И чем шире задача, тем сложнее его читать (см. пример за соседним углом в репозитории learning-python-from-zero папка Lesson 8 файл MachineLearning1.py) - ревизия содержимого датафрейма содержащая попытку понять основные индикаторы это порядка 200+ строк кода, который особо не откомментрируешь.




- у меня в студии уже лежит 200+ строк 
